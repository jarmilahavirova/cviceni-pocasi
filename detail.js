...
const denniData = predpoved.find((den) => den.id === denId);
const mainElement = document.querySelector("main");

mainElement.innerHTML += `
  <article>
    <h2>${denniData.den}</h2>
    <p>Ranní teploty: ${denniData.denni_teplota}°C</p>
    <p>Odpolední teploty: ${denniData.odpoledni_teplota}°C</p>
    <p>Večerní teploty: ${denniData.vecerni_teplota}°C</p>
    <p>Celkový stav: ${denniData.stav_pocasi}</p>
    <p>Tlak: ${denniData.tlak}hPA</p>
    <p>Rychlost větru: ${denniData.rychlost_vetru} m/s</p>
    <p>Popis: ${denniData.popis_pocasi}</p>
  </article>
`;
